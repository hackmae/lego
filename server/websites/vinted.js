...
const scrapeWithCookies = async searchText => {
  try {
    ...
    const response = await fetch("https://www.vinted.fr/api/v2/catalog/items?page=1&per_page=96&time=1739198768&search_text='42182&catalog_ids=&size_ids=&brand_ids=&status_ids=&material_ids=", {
        "headers": {
          ...
          "Referer": "https://www.vinted.fr/catalog?search_text=42182&time=1739198768",
